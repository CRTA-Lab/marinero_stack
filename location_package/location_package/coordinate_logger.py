...
class CoordinateLogger(Node):
    def __init__(self):
        ...
        self.abort_publisher = self.create_publisher(String, "/abort_mission", 10)
    ...
    def listener_callback(self, msg):
        ...
        for data in divided_data:
            ...
            if data == "startFile":
                ...
                self.process_coordinate_data("(197.212,280.830,-3.10)") # docking station
            elif data == "abortMission":
                self.abort_mission()
            else:
    ...
    def abort_mission(self):
        self.abort_publisher.publish(String(data="Abort mission!"))
        ...
        try:
            ...
            if len(coords) >= 3:
                coord_dict = {
                    ...
                    'y': coords[1], # y position
                    # 'z': coords[2], # z position
